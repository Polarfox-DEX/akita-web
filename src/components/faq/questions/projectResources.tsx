const projectResources = (
  <>
    ...
    <ul className="list-disc ml-1 list-decimal list-inside">
      ...
      <li>
        By having 0.03% fees on every transaction involving the PFX token. Coupled to the deflationary nature of PFX,
        this should be enough by itself to fund the team.
      </li>
    </ul>
  </>
)
