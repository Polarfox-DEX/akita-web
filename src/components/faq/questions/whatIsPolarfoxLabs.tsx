const whatIsPolarfoxLabs = (
  <>
    ...
    <p>
      Polarfox will first create a DEX. This will solve the main issue for building DeFi products, which is sufficient
      liquidity. The DEX will as well act as the main source of funds for the dev team to further develop the ecosystem.
    </p>
  </>
)

export default whatIsPolarfoxLabs
